...
def inference(input_tensor, train, regularizer):
      ...
      with tf.variable_scope('layer2-conv2'):
            # conv2_bn1 = batch_norm(conv1, decay=DECAY, is_training=train)
            conv2_bn1 = batch_norm(conv1, train, CONV1_DEEP, 1)
            ...
            # conv2_bn2 = batch_norm(conv2_bottleneck, decay=DECAY, is_training=train)
            conv2_bn2 = batch_norm(conv2_bottleneck, train, CONV2_DEEP_BOTTLENECK, 2)
      ...
      with tf.variable_scope('layer3-conv3'):
            ...
            # conv3_bn1 = batch_norm(conv3_concat, decay=DECAY, is_training=train)
            conv3_bn1 = batch_norm(conv3_concat, train, CONV1_DEEP+CONV2_DEEP, 1)
            ...
            # conv3_bn2 = batch_norm(conv3_bottleneck, decay=DECAY, is_training=train)
            conv3_bn2 = batch_norm(conv3_bottleneck, train, CONV3_DEEP_BOTTLENECK, 2)
      ...
      with tf.variable_scope('layer4-conv4'):
            ...
            conv4_bn1 = batch_norm(conv4_concat, train, CONV1_DEEP+CONV2_DEEP+CONV3_DEEP, 1)
            ...
            # conv4_bn2 = batch_norm(conv4_bottleneck, decay=DECAY, is_training=train)
            conv4_bn2 = batch_norm(conv4_bottleneck, train,CONV4_DEEP_BOTTLENECK, 2)
      ...
      with tf.variable_scope('layer5-softmax'):
            ...
            # softmax = batch_norm(softmax, decay=DECAY, is_training=train)
